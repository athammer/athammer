...
class Home extends React.Component {
    ...
    render() {
        return (<div className="home-render">
            ...
            <h5 className="text-muted">Hosted on AWS's ec2, find the repository
                <span className="divRepo">
                    <a className="repo" href="https://github.com/athammer/AaronTHammer.me" target="_blank" rel="noopener noreferrer">here</a>
                </span>
            </h5>
        </div>)
    }
